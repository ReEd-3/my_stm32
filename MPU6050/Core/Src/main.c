...
//	HAL_I2C_Mem_Read(I2Cx, MPU6050_ADDR, WHO_AM_I_REG, 1, &check, 1, 1000); // 检查

//	if (check == 0x68){ // WHO_AM_I值应为0x68
//		HAL_UART_Transmit(&huart1, (uint8_t*)"Link\n", 5, 1000);
////		HAL_UART_Transmit(&huart1, &check, 1, 1000);
//	}
